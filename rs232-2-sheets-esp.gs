// Created by Sujay S. Phadke, 2017 (and tinkered with by RToledo-Crow)
...
var SS = SpreadsheetApp.openById('here-put-the-key-to-your-google_sheets');
var sheet = SS.getSheetByName('Sheet1'); // don't chane name of tab
var str = "";

// on open will make a clear all item in menu and will add the top row of sheet
function onOpen() { 
